...
func RegisterMQTTRoutes(r *gin.Engine, cfg Config) {
...
func RegisterMetricsRoutes(r *gin.Engine, cfg Config) {
...
func RegisterStreamRoutes(r *gin.Engine, cfg Config) {
...
func RegisterSpecializedRoutes(r *gin.Engine, cfg Config) {
	devicesHandler := devices.NewHandler(cfg.Store, cfg.MQTTBroker)
	dataHandler := data.NewHandler(cfg.Store, cfg.Processor, cfg.MQTTBroker)
...
func RegisterSSERoutes(r *gin.Engine, cfg Config) {
...
func RegisterDBRoutes(r *gin.Engine, cfg Config) {
...
func RegisterProvisioningRoutes(r *gin.Engine, cfg Config) {
